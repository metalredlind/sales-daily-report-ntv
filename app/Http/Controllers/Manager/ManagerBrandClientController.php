...
use App\DataTables\ManagerBrandClientDataTable;
...
class ManagerBrandClientController extends Controller
{
    /**
     * Display a listing of the resource.
     */
    public function index(ManagerBrandClientDataTable $dataTable)
    {
        return $dataTable->render('manager.brand-client.index');
    }
    ...
    public function create()
    {
        ...
        return view('manager.brand-client.create', compact('users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('manager.brand-client.index');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('manager.brand-client.edit', compact('brandClient', 'users'));
    }
    ...
    public function getData(ManagerBrandClientDataTable $dataTable)
    {
