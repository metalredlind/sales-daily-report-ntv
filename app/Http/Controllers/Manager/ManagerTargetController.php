...
class ManagerTargetController extends Controller
{
    ...
    {
        return $dataTable->render('manager.target-sales.index');
    }
    ...
    public function create()
    {
        ...
        return view('manager.target-sales.create', compact('users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('manager.target-sales.index')->with('success', 'Target Sales created successfully.');
    }
    ...
    {
        return view('manager.target-sales.edit');
    }
