                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <a href="{{ route('sales.brand-client.create') }}" class="btn btn-primary">
                                    + Add New
                                </a>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#daterange').on('apply.daterangepicker', function(ev, picker) {
                ...
                var table = $('#salesbrandclient-table').DataTable();
                // Reload the table with new date range filters
                table.ajax.url('{{ route("sales.brand-client.data") }}?start_date=' + startDate + '&end_date=' + endDate).load();
            });
        });
    </script>
@endpush
